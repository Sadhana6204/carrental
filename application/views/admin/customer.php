...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?php echo base_url().'admin/customer_add'; ?>" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Add Customers</a>
</div>
            ...
            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $k->customer_sex ?></td>
                        <td><?php echo '<i class="fas fa-phone-volume"></i> '.$k->customer_phone.'<br><i class="fas fa-id-card-alt"></i> '.$k->customer_license; ?></td>
