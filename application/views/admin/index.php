        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $this->m_rental->edit_data(array('car_status'=>1),'car')->num_rows(); ?>/<?php echo $this->m_rental->get_data('car')->num_rows(); ?></div>
            </div>
            <div class="col-auto">
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $this->m_rental->edit_data(array('booking_status'=>1),'booking')->num_rows(); ?></div>
            </div>
            <div class="col-auto">
      ...
      <div class="card shadow mb-4">
        ...
        <?php foreach($car as $m){ ?>
            <a href="admin/car" class="list-group-item list-group-item-action">
                <i class="fas fa-car"></i> <?php echo $m->car_brand; ?>
                <?php 
                    if($m->car_status == 1){ 
                ...
                <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php foreach($booking as $t){ ?>
                      <tr>
                        ...
                        <td><?php echo $t->car_brand; ?></td>
                        <td><?php echo date('d/m/Y',strtotime($t->booking_borrow)); ?></td>
                        <td><?php echo date('d/m/Y',strtotime($t->booking_return)); ?></td>
                        <td><?php echo 'Rs. '.number_format($t->booking_price).'/-'; ?></td>
                        <td class="text-center"><?php echo ($t->booking_status == 1)?'<i class="fas fa-check-circle" style="color:green;"></i> Finished':'<i class="fas fa-times-circle" style="color:red;"></i> Not Finished'; ?></td>
                      </tr>
                  <?php } ?>
                  </tbody>
                </table>
